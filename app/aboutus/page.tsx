  ...
  return (
    <div className='bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:14px_24px] p-xl mt-2xl flex flex-col gap-8 '>
      ...
      <section>
        <h2>What We Do</h2>
        <p>
          Our platform generates custom comedy shows tailored to your unique sense of humor. 
          Whether you love dry wit, slapstick humor, or clever puns, our AI is trained on a vast library of comedic 
          styles and can craft the perfect set to leave you in stitches. From short skits to full-length stand-up routines, 
          we bring the best in AI-generated comedy straight to your screen.
        </p>
      </section>
